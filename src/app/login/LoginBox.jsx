    ...
    >
      <Form>
        ...
        <div className="password flex flex-col mt-8 mb-6">
          ...
          <div className="inputWithIcon w-full relative ">
            ...
            <Field
              ...
              name="password"
              className={`outline-none focus:border-black/40 transition w-full text-[16px] text-[#111827] border border-[#E2E8F0] rounded-lg py-2.5 pr-10 pl-2 p text-end ${showPass ? '' : 'tracking-[0.2em] font-mono'}`}
              placeholder="••••••••"
            />
          </div>
          <ErrorMessage
        ...
        <div className="rememberMe flex justify-between mb-6">
          ...
          <Link
            href="/signup"
            className=" text-[14px] text-[#0D9488] font-bold hover:underline"
          >
            أريد انشاء حساب
          </Link>
          {/* remember me  */}
          <div className=" w-fit gap-2 flex">
            <label htmlFor="" className="text-[14px] text-[#4B5563] ">
              تذكرني
            </label>
            <Field
              name="remember"
        ...
        <button
          type="submit"
          className=" text-[16px]  justify-center font-bold text-white bg-[#0D9488] px-3 flex py-3 w-full rounded-lg mb-8"
        >
          دخول النظام
        </button>
