...
export default function page() {
  return (
    <div className=' bg-[#F8FAFC] w-full h-dvh flex justify-center items-center flex-col gap-4 '>
        <TitleAndLogo />
<h1 className=' text-[22px] md:text-[26px] text-[#111827] font-bold my-1 md:my-2'>إنشاء حساب جديد</h1>
<p className=' whitespace-nowrap text-[#64748B] text-[15px] '>ابدأ بإدارة عيادتك باحترافية وسهولة اليوم</p>
