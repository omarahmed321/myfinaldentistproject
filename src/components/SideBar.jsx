...
import { Calendar, ChartColumn, LayoutDashboard, LogOut, Menu, Settings, Users, X } from 'lucide-react'
...
useEffect(() => {
  modal
    ...
    : (document.body.style.overflow = "unset", document.documentElement.style.overflow = "unset");
}, [modal]);
...
let optionClassname = ` flex w-fit ml-auto py-2.5 `;
  ...
  <div className="TitleandLogo lg:pt-3  pb-3  border-b border-[#0F172A]">
    ...
    <div className="logo bg-[#0D9488] rounded-xl md:h-8 md:w-8 lg:h-8 h-8 w-8 lg:w-8 flex justify-center items-center "><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" ><path d="M11 2v2"/><path d="M5 2v2"/><path d="M5 3H4a2 2 0 0 0-2 2v4a6 6 0 0 0 12 0V5a2 2 0 0 0-2-2h-1"/><path d="M8 15a6 6 0 0 0 12 0v-3"/><circle cx="20" cy="10" r="2"/></svg></div>
</div>
{/* the main options
 */}
  </div>
...
تسجيل الخروج <LogOut className="ml-2 text-white  " />
    ...
    {/* overlay */}
    <div onClick={()=>{setModal(false)}} className={`Overlay fixed inset-0  z-20 bg-black/30 lg:hidden blur-xs ${modal? 'block':'hidden'}`}>
